...
// fmtF–¢Žg—p(«—ˆ‚Ö‚ÌŠg’£‚Ì‚½‚ß‚Éˆø”‚Æ‚µ‚Ä“ü‚ê‚Ä‚¨‚­)
...
n = print1("%0lx", 258120);
printf("\n n = %d\n", n);
// printHex(FLAG_BOTH, SIZE_4BYTE, HEX_LOWERCASE, 258120);
n = print1("%#0lx", 258120);
printf("\n n = %d\n", n);
// printHex(FLAG_BOTH, SIZE_2BYTE, HEX_UPPERCASE, 10);
n = print1("%#0hd", -32768);
printf("\n n = %d\n", n);
return 0;
}
...
// 32-bit integer ‚ÌÅ‘å‚Í 4294967295,‚Â‚Ü‚è, 10Œ…
#define MAX_DIGIT 10
#define BASE10 10
